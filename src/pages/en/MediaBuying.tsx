...
import { ArrowLeft, BrainCircuit, Target, Database, Settings, LineChart, Bot } from "lucide-react";
    ...
    <div className="min-h-screen p-8 bg-[#000000]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg mb-16">
          <h2 className="text-2xl font-bold mb-8 text-black">🛠️ Technologies & Tools</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold mb-8 text-black">📁 Strategic Case Studies</h2>
