      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12 relative z-10">
        ...
        <div className="space-y-6">
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-2xl text-primary-darker font-bold">Contact Information</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="space-y-3 text-base">
                <div className="flex justify-between items-center py-2 border-b border-primary/20 last:border-b-0">
                  <span className="font-bold text-primary-darker">Monday - Friday</span>
                  <span className="text-primary-dark">9:00 - 18:00</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-primary/20 last:border-b-0">
                  <span className="font-bold text-primary-darker">Saturday</span>
                  <span className="text-primary-dark">Closed</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="font-bold text-primary-darker">Sunday</span>
                  <span className="text-primary-dark">Closed</span>
                </div>
              </div>
            </CardContent>
