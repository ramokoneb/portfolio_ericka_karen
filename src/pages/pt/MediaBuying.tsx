    ...
    <div className="min-h-screen p-8 bg-[#000000]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg mb-16">
          <h2 className="text-2xl font-bold mb-8 text-white">Tecnologias & Ferramentas 🛠️</h2>
        ...
        <div className="mt-16 bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold mb-6 text-white">Casos de Sucesso Estratégicos 🎯</h2>
          <div className="grid md:grid-cols-2 gap-8">
