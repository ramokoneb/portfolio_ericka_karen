...
const mediaBuyingCases: CaseItem[] = [
  {
    title: "Febracis Loja Virtual — Da Crise ao Crescimento Exponencial",
    description: "Após 6 meses de prejuízo em mídia paga, implementamos abordagens estratégicas alcançando R$77.000 em receita mensal (267% de crescimento) com 963% de ROAS. A estratégia envolveu uma revisão completa da estrutura de campanhas, segmentação avançada de público e implementação de um sistema de rastreamento personalizado que permitiu a otimização precisa do orçamento de mídia, resultando em uma transformação completa dos resultados do e-commerce.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
    tags: ["Meta Ads", "Google Ads", "ROAS", "E-commerce"]
  },
  {
    title: "Urban Effort — Do Zero ao Ponto de Equilíbrio em 3 Meses",
    description: "Marca americana de chapéus que vendia apenas na Amazon criou seu próprio canal de vendas atingindo o ponto de equilíbrio em menos de 90 dias com +291% de crescimento em receita. Desenvolvemos uma estratégia multicanal focada em construção de marca e conversão direta, usando Meta Ads e Google Ads de forma sincronizada para alcançar clientes potenciais em diferentes momentos da jornada de compra.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
    tags: ["Meta Ads", "Google Ads", "E-commerce"]
  },
  {
    title: "Borogodó Brasil — Virada de Receita em 30 Dias",
    description: "Após uma queda drástica nas vendas, estratégias focadas em Meta Ads alcançaram +36% de visitas únicas, +24% de vendas, +40% de receita e +13% de ticket médio em apenas um mês. A abordagem incluiu uma reestruturação completa das campanhas focando na segmentação por interesse e comportamento, criação de funis específicos para diferentes categorias de produtos e implementação de remarketing avançado para recuperação de carrinho abandonado.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
    tags: ["Meta Ads", "E-commerce", "Receita"]
  },
  {
    title: "Vamos — +50% em Vendas com Aquisição Inteligente",
    description: "Empresa de locação de veículos pesados escalou sua base de clientes com segmentação geográfica e demográfica direcionada, alcançando +50% em vendas em um único mês. A estratégia envolveu mapeamento detalhado de clientes potenciais por região, criação de campanhas geolocalizadas com mensagens personalizadas por setor e um sistema de qualificação de leads que priorizava contatos com maior probabilidade de fechamento.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
    tags: ["Meta Ads", "Geração de Leads", "Vendas"]
  },
  {
    title: "Unileão — 118% de Redução em CPL com Performance Max",
    description: "Instituição educacional otimizou a geração de leads com campanhas Performance Max, alcançando 118% de redução no custo por lead e ROI positivo no primeiro mês. O projeto incluiu implementação avançada do Google Ads focando em Performance Max, criação de ativos criativos otimizados para diferentes segmentos de público, integração com CRM para rastreamento de conversão de matrículas e otimização contínua baseada em dados de qualidade de leads.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
    tags: ["Google Ads", "Educação", "Performance Max"]
  },
  {
    title: "Rastreamento Inteligente de WhatsApp — +462% em Conversas",
    description: "Implementação de rastreamento via ctwaclid em campanhas do Meta Ads levou a um aumento de +462,16% em conversas iniciadas e redução de 81,34% no custo por mensagem enviada em apenas uma semana. O sistema personalizado permitiu a identificação precisa da origem dos leads do WhatsApp, possibilitando otimização e escalabilidade em campanhas focadas em custo por conversa iniciada, além de melhor atribuição de resultados.",
    image: "/lovable-uploads/31fc646a-6cf4-478c-9d76-e389e609a2bb.png",
