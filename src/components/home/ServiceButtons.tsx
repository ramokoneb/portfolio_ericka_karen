  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:gap-6 justify-center">
      <Link to={`${basePath}/media-buying`} className="w-full md:w-[300px]">
        <Button 
          size="lg" 
          className="w-full min-h-[56px] md:min-h-[64px] text-sm md:text-base px-4 py-3 md:px-5 lg:px-6 bg-[#6CAAD9] hover:bg-[#5a9bcd] text-white flex items-center justify-center whitespace-normal text-center rounded-md shadow-sm"
